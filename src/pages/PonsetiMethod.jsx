    ...
    <div>
      ...
      <div className="px-4 pt-6 pb-8 space-y-6">
          ...
          {steps.map((step) => (
            <div key={step.number} className="bg-white rounded-2xl shadow-sm p-5">
              <div className="flex items-start gap-4">
                <span className="text-2xl font-bold text-slate-200 leading-none mt-0.5 tabular-nums">
                  {step.number}
                </span>
          ...
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1.5">
              ...
              <p className="text-sm text-amber-700 leading-relaxed">
                Casting corrects the foot. <strong>Bracing holds the correction.</strong> The number one cause of relapse is stopping the brace early or inconsistently. The brace phase feels long — sometimes years — but compliance is what determines whether the correction lasts. This is the part that requires the most from families, and it's the part that matters most.
              </p>
            </div>
          </div>
        </section>
        ...
        <section className="bg-white rounded-2xl shadow-sm p-5 space-y-2">
          ...
          <p className="text-sm text-slate-600 leading-relaxed">
            With proper treatment and brace compliance, over 95% of children treated with the Ponseti method go on to walk, run, play sports, and live without limitations. The foot may be slightly smaller or the calf slightly thinner on the affected side, but function is typically normal. Most adults treated as infants have no awareness of any difference in daily life.
          </p>
        </section>
        ...
        {/* Bottom callout */}
        <section className="bg-slate-800 rounded-2xl p-5 space-y-3">
          <p className="text-white font-semibold text-sm">Ready to go deeper?</p>
          <p className="text-slate-300 text-sm leading-relaxed">
            This guide covers every phase of the Ponseti journey in detail — from the first cast to long-term follow-up.
          </p>
          <button
            onClick={() => navigate("/")}
            className="w-full py-3 rounded-xl bg-white text-slate-800 font-semibold text-sm active:scale-95 transition-transform"
          >
