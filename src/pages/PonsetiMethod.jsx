    ...
    <div className="bg-neutral-950 min-h-screen">
      ...
      <div className="px-4 pt-2 pb-10 space-y-4">
        ...
        <div className="bg-neutral-800 rounded-2xl p-5 space-y-2">
          <h2 className="font-semibold text-white text-base">What it is</h2>
        ...
        <section className="space-y-2">
          ...
          {steps.map((step) => (
            <div key={step.number} className="bg-neutral-800 rounded-2xl p-5">
              <div className="flex items-start gap-4">
                <span className="text-2xl font-bold text-neutral-600 leading-none mt-0.5 tabular-nums">
                  {step.number}
                </span>
        ...
        {/* Why it works */}
        <div className="bg-neutral-800 rounded-2xl p-5 space-y-2">
          <h2 className="font-semibold text-white text-base">Why it works</h2>
          <p className="text-sm text-neutral-400 leading-relaxed">
        ...
        <div className="bg-amber-400/10 border border-amber-400/30 rounded-2xl p-5">
          <div className="flex items-start gap-3">
            ...
            <div className="space-y-1.5">
              <h2 className="font-semibold text-amber-300 text-sm">The single most important thing</h2>
              <p className="text-sm text-amber-200/70 leading-relaxed">
                Casting corrects the foot. <strong className="text-amber-300">Bracing holds the correction.</strong> The number one cause of relapse is stopping the brace early or inconsistently. The brace phase feels long — sometimes years — but compliance is what determines whether the correction lasts.
              </p>
            </div>
          </div>
        </div>
        ...
        {/* Success rate */}
        <div className="bg-neutral-800 rounded-2xl p-5 space-y-2">
          <h2 className="font-semibold text-white text-base">Success rate</h2>
          <p className="text-sm text-neutral-400 leading-relaxed">
        ...
        {/* Who developed it */}
        <div className="bg-neutral-800 rounded-2xl p-5 space-y-2">
          <h2 className="font-semibold text-white text-base">Who developed it</h2>
          <p className="text-sm text-neutral-400 leading-relaxed">
