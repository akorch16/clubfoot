...
const phases = [
  {
    ...
    label: "Prenatal",
    emoji: "🤰",
    description: "What to know before baby arrives — diagnosis, preparation, finding care.",
    color: "bg-violet-500",
  },
  {
    id: "casting",
    label: "Casting",
    emoji: "🦶",
    description: "Serial casting corrects the foot shape over 5–8 weeks.",
    color: "bg-sky-500",
  },
  {
    id: "boots-and-bar",
    label: "Boots & Bar",
    emoji: "👟",
    description: "The brace that holds the correction — the longest and most critical phase.",
    color: "bg-teal-500",
  },
  {
    id: "long-term",
    label: "Long-term",
    emoji: "🏃",
    description: "After bracing ends — monitoring, activity, and life without limitations.",
  ...
  return (
    <div className="bg-neutral-950 min-h-screen">
      ...
      <div className="px-5 pt-12 pb-6">
        ...
        <p className="text-neutral-400 text-sm mt-2">Written by parents who've been there.</p>
      </div>

      <div className="px-4 pb-10 space-y-3">
        {/* Phase label */}
        <p className="text-xs font-semibold text-neutral-500 uppercase tracking-widest pb-1">
          Treatment Phases
        </p>
        ...
        {phases.map((phase) => (
          <button
            ...
            className={`relative w-full ${phase.color} rounded-2xl py-5 px-5 text-left overflow-hidden active:scale-95 transition-transform`}
          >
            {/* Ghost emoji texture */}
        ...
        <div className="bg-amber-400 rounded-2xl px-5 py-4">
          <p className="text-amber-950 font-semibold text-sm text-center">
            95% of kids go on to live without limitations.
          </p>
        </div>
      </div>
    </div>
