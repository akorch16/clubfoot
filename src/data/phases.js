...
export const phases = [
  {
    ...
    tips: [
      {
        title: "How do I find a doctor for clubfoot?",
        detail:
      ...
      {
        title: "What clothes do I need to buy?",
        detail:
      ...
      {
        title: "How should I prepare my support circle?",
        detail:
      ...
      {
        title: "How do I find the right car seat?",
        detail:
      ...
      {
        title: "What does the treatment timeline look like?",
        detail:
      ...
      {
        title: "What if my child's clubfoot is atypical or syndromic?",
        detail:
  ...
  },
  {
    ...
    keyPointGroups: [
      ...
      },
      {
        ...
        points: [
          ...
          "It's a short procedure, usually done in the office under local anesthetic for young babies, though some providers use sedation or a light general depending on the child's age and the setting.[[5]] It's minor as far as surgeries go, but the tendon is cut all the way across so it can regrow to a new, functional length.",
        ],
      },
      {
    ...
    tips: [
      {
        title: "How do I bathe my baby with casts on?",
        detail:
      ...
      {
        title: "What clothes work with full-leg casts?",
        detail:
      ...
      {
        title: "How do car seats work with casts?",
        detail:
      ...
      {
        title: "How do I track our casting progress?",
        detail:
    ...
    encouragement: {
      ...
      body: "The Ponseti method makes small corrections at every appointment. Most babies need 4-8 casts, and you can see the change week to week. The entire process generally takes around two months.",
    },
    videos: [
      {
  ...
  },
  {
    ...
    tips: [
      {
        title: "What socks help prevent blisters?",
        detail:
      ...
      {
        title: "What do I do when my baby escapes the brace?",
        detail:
      ...
      {
        title: "How do I build a brace routine?",
        detail:
      ...
      {
        title: "What clothes work with the bar?",
        detail:
      ...
      {
        title: "How do I baby-wear with the bar?",
        detail:
      ...
      {
        title: "Which strollers work with the bar?",
        detail:
      ...
      {
        title: "How do I handle night waking in the brace?",
        detail:
      ...
      {
        title: "What are the early signs of relapse?",
        detail:
  ...
  },
  {
    ...
    tips: [
      {
        title: "How often do we need check-ups?",
        detail:
      ...
      {
        title: "What shoes are best after treatment?",
        detail:
      ...
      {
        title: "Does my child need physical therapy?",
        detail:
      ...
      {
        title: "Does my child need custom orthotics?",
        detail:
      ...
      {
        title: "How do I talk to my child about clubfoot?",
        detail:
      ...
      {
        title: "How long do we watch for relapse?",
        detail:
